  ...
  return (
    <div className="about-us-container">
      ...
      <ol>
        ...
        <li>They include one ingredient that tries to do a little bit of everything—but isn't good at anything.</li>

        <li>They are heavy in fragrances and additives</li>

        <li>They hide behind confusing industry lingo.</li>

        <li>They're priced like Ferraris and perform like golf carts. 🚗</li>
      </ol>
    </div>
    </div>
  );
...
Big 🤬 problems with today's skincare products.
...
They’re heavy on fragrance and harmful additives.
...
They’re priced like luxury cars and perform like bicycles. 🚴‍♀️
